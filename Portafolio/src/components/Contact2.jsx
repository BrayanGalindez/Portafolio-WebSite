...
function Contact() {
  ...
  const { contactDetailsTitle, phoneNumber, emailAddress, address } =
    dataContact;
  return (
    <section id="contact" className="py-8 bg-white dark:bg-gray-900">
      <div className="max-w-5xl mx-auto">
        <div className="max-w-md mx-auto py-8">
          <div className="bg-gray-200 dark:bg-indigo-950 rounded-lg shadow-md p-6 mx-4 ms md:mx-0">
            <div className="mt-8 dark:text-white ">
              <h3 className="text-2xl font-bold mb-2">{contactDetailsTitle}</h3>
